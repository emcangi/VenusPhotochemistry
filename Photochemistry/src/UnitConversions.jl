...
#                                                                              #
# **************************************************************************** #
# Checked for planet-agnosticism 30-May-2023
...
function total_escape_to_GEL(esc_per_s, t, HorH2O; SA=SA_Venus)
    #=
    ...
    esc_per_cm2 = esc_per_s * (t * s_per_yr) * (1/SA) 
    return molec_to_GEL(esc_per_cm2, HorH2O)
end

function total_escape_to_area_escape(esc_per_s; SA=SA_Venus)
    #=
